    ...
    <header className="w-full border-b border-border bg-transparent">
      <div className="container mx-auto flex items-center justify-between py-4 px-2">
        <Link href="/" className="flex items-center gap-3">
          <div className="h-10 w-10 rounded-2xl bg-linear-to-br from-primary to-secondary flex items-center justify-center text-white font-semibold">LP</div>
          <div>
        ...
        <nav className="flex items-center gap-4">
          ...
          <Link href="/dashboard" className="hidden md:inline text-sm font-medium text-textDark dark:text-[#EDEDF2]">Dashboard</Link>
